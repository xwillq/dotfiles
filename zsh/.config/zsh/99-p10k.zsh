# Generated by Powerlevel10k configuration wizard on 2023-11-12 at 15:17 +05.
...
() {
  ...
  typeset -g POWERLEVEL9K_VPN_IP_INTERFACE='(gpd|wg|(.*tun)|tailscale|ppp|ipsec)[0-9]*|(zt.*)'
