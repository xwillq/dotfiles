...
local function strip_last_space(value)
    if type(value) == "string" then
        return value:gsub(" $", "")
    else
        return vim.tbl_map(strip_last_space, value)
    end
end

-- Neo-tree adds spaces to all icons by default, so we will strip them
icons = vim.tbl_map(strip_last_space, icons)
