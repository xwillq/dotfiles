...
# Automatically add `/` after completing directory names
setopt AUTO_PARAM_SLASH
# Remove automatically added `/` if next character is delimiter or ends command
setopt AUTO_REMOVE_SLASH

# Don't go to the end of the word when completing inside of the word
...
#-------------------------------------------------------------------------------
# Initialize and cache completions
#-------------------------------------------------------------------------------

# Copied from https://github.com/zimfw/completion/blob/master/init.zsh
() {
